...
export function TaskList({ tasks, onTasksReorder, onTaskUpdate, onTaskDelete, loading = false, extracting = false, canExtract = false, onExtract, planId, planStatus, onPublish, onRePublish, planName, planDescription }: TaskListProps) {
        ...
        <header className="p-4 border-b border-gray-700">
          ...
          {planStatus === 'PUBLISHED' && (
            <div className="mt-3 flex items-center gap-2">
              {/* Published 徽章 */}
              <div className="flex-1 px-3 py-2 bg-green-900/30 border border-green-700 text-green-400 rounded-lg text-sm flex items-center gap-2">
